...
createFullSubmission = function (){
  ...
  predDog3 = read.table(paste0(path,"Submission\\Dog3.csv"), header =TRUE, sep =",")
  ...
  predPat1 = read.table(paste0(path,"Submission\\Patient1.csv"), header =TRUE, sep =",")
  predPat1$clip = as.character(predPat1$clip)
  predPat1$preictal = as.numeric(predPat1$preictal)
  predPat2 = read.table(paste0(path,"Submission\\Patient2.csv"), header =TRUE, sep =",")
